...
def plot(df):
    ...
    plt.title(
        f"Primary Education Gap ({age_filter})\nExcess rate of Primary or Lower Secondary Education being the highest level attained by disabled vs. able bodied people"
    )
